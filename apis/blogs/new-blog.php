...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if(!isset($_POST['title']) || $_POST['title'] === ''){
            ...
            $stmt = $conn->prepare("INSERT INTO blogs (title,subtitle,description,image_link,blogger_name) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("sssss", $_POST['title'], $_POST['subtitle'], $_POST['description'],$_POST['image_link'],$_POST['blogger_name']);
